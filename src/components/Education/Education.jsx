  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Vertical line */}
        <div className="absolute left-4 sm:left-1/2 transform sm:-translate-x-1/2 w-[2px] bg-white/60 h-full"></div>
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            <div
              ...
              } sm:ml-44 sm:mr-44 ml-10 sm:ml-44 transform transition-transform duration-300 hover:scale-105`}
            >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:space-x-6">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="text-sm sm:text-sm text-gray-300 mt-1">
                      {edu.school}
                    </h4>
                  </div>
                  {/* Date at the bottom */}
